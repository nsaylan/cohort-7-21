...
@app.route('/')
def home():
    return render_template("index.html", name='Necip')

# Write a function named `greet` which uses template file named `greet.html` given under `templates` folder. it takes parameters from query string on URL. 
# Assign that parameter to the 'user' variable. If it doesn't have any parameter, warning massage is raised
